...
router.get('/', checkAuth([roles.ADMIN, roles.STUDENT, roles.TUTOR]), tutorController.getAllTutors);
router.get('/:id', checkAuth([roles.ADMIN, roles.STUDENT, roles.TUTOR]), tutorController.getTutor);
router.delete('/:id', checkAuth([roles.ADMIN]), tutorController.deleteTutor);
router.put('/:id', checkAuth([roles.ADMIN, roles.STUDENT, roles.TUTOR]), tutorController.updateTutor);
router.post(
  '/avatar/:username',
...
router.get('/video/:username', checkAuth([roles.ADMIN, roles.STUDENT, roles.TUTOR]), tutorController.streamVideo);
