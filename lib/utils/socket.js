...
const initSocket = (socket) => {
  ...
  socket
    ...
    .on(SOCKET_EVENTS.CREATE_CALL_HISTORY, async (student) => {
      endTime = Date.now();
      ...
      try {
        CallHistory.create({
          ...
          duration: duration,
          studentVideo: `uploads/callHistories/${callId}/student.webm`,
          tutorVideo: `uploads/callHistories/${callId}/tutor.webm`
        });
